...
public class HarryYouth {
	...
	//boolean alive, int charisma, int intelligence, int strength, int wealth, int confidence, int age) 
	Outcome [] outcomeLineC4 = new Outcome []{
			new Outcome(true, 5, 1, 0, 0, 2, 0),
			new Outcome(true, -2, 5, -1, 0, -2, 0),
			new Outcome(true, 3, -2, 0, -1, 5, 0),
			new Outcome(true, 3, 0, 0, 2, 6, 0),
			null,
			null,
			null,
			...
			null,
			null,
			new Outcome(true, 0, 0, 0, 0, -5, 0),
			new Outcome(true, 2, 0, 0, 0, 1, 0)
	};
	...
	Requirements r4 [] =  {
			new Requirements(0, 0, 0, 0, 0),
			new Requirements(-1,-1,-1,-1,-1),
			new Requirements(0,0,0,0,5),
			new Requirements(0,0,0,5,0),
	};
	...
	Choice c4 = new Choice("You have come of age to choose what your family life will be like. \n1.Be a happy content boy that always does what their parents say. \n2.Stay in your room and study and obey your parents whenever. \n3.Your a rebel...Enough said. \n4.You follow in the excessive and bourgeois lifestyle of your parents", 
			c4Story, r4, outcomeLineC4, d, d.getAge(), d.getCharisma(), d.getIntelligence(), d.getStrength(), d.getWealth(), d.getConfidence());
	...
	//boolean alive, int charisma, int intelligence, int strength, int wealth, int confidence, int age) 
	Outcome [] outcomeLineC5 = new Outcome []{
			new Outcome(true, 3, 2, 0, 0, 2, 1),
			new Outcome(true, 3, 0, 0, 0, 5, 0),
			new Outcome(true, 3, 0, 0, 1, 5, 0),
			new Outcome(true, 4, 3, 0, 0, 0, 0),
